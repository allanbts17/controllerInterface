...
public class ExecutionTypePanel extends JPanel {
	...
	public ExecutionTypePanel() {
		...
		icon[1] = new ImageIcon(this.getClass().getResource("/icons/carrillon_btn_unpressed.png"));
		icon[2] = new ImageIcon(this.getClass().getResource("/icons/bandeo_btn_unpressed.png"));
		icon[3] = new ImageIcon(this.getClass().getResource("/icons/toques_btn_pressed.png"));
		icon[4] = new ImageIcon(this.getClass().getResource("/icons/carrillon_btn_pressed.png"));
		icon[5] = new ImageIcon(this.getClass().getResource("/icons/bandeo_btn_pressed.png"));
